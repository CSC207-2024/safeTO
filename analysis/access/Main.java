...
public class Main {
    public static void main(String[] args) {
        ...
        List<StolenCarData> pastYearData = calculator.getStolenCarDataWithinRadiusPastYear(latitude, longitude, radius);
        ...
        List<StolenCarData> allData = calculator.getStolenCarDataWithinRadius(latitude, longitude, radius);
