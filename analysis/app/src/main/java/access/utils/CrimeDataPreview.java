...
/*
        ...
        Set<String> uniqueMciCategories = new TreeSet<>(table.stringColumn("MCI_CATEGORY").asSet());

        // Print unique values
        System.out.println("Unique NEIGHBOURHOOD_140 values (sorted):");
        for (String neighborhood : uniqueNeighborhoods) {
            System.out.println(neighborhood);
        }

        System.out.println("Unique MCI_CATEGORY values:");
        for (String mciCategory : uniqueMciCategories) {
            System.out.println(mciCategory);
        }
    ...
    *//**
     ...
     *//*
    private static void saveUniqueValuesToFile(String fileName, Set<String> values) {
