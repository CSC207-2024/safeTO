                ...
                <div className={className}>
                    ...
                    <div className='select-container'>
                        ...
                        <p>Please select Crime Type &nbsp;
                            <select id="crime-select" name="crimeType" value={selectedCrimeType}
                            ...
                            </select>, and click <button onClick={showNeighbourhoodRanking}
                                                         className="ranking-button">See
                                Rankings</button></p>
                    </div>
                            ...
                            {rankingResult ? (
                                <div>
                                    {rankingResult.ranking && rankingResult.safetyLevel ? (
                                        <p> Based on the TPS database, the "{selectedCrimeType}" ranking
                                            in {selectedNeighbourhood} is <i>{rankingResult.ranking}</i>. The safety
                                            level is <i>{rankingResult.safetyLevel}</i>. </p>
                                    ) : (
            ...
            <Modal
                ...
                <div className='select-container'>
                    ...
                    <div className="range-container">
                        <label htmlFor="threshold-select">2. How strict do you want the probability calculation to
                            be: </label>
                        <input
                            type="range"
                            id="threshold-select"
                        ...
                        />
                        <p className="range-text">&nbsp;  Selected value: {selectedThreshold} (<i>Note: 1 for most
                            strict and 10 for the least strict)</i></p>
                    </div>
                ...
                {isLoading ? (
                    ...
                    analysisResults ? (
                        <div className='analysis-results'>
                            ...
                            <p>Crime
                                Probability: {analysisResults.probability ? analysisResults.probability.toFixed(2) : 0}</p>
                        ...
                        <div className='analysis-results'>
                            ...
                            <p>Message: Based on the <i>location, probability threshold, year</i> you selected, there is
                                no data from Toronto Police Service Database. Try to set different parameters.</p>
